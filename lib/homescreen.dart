import 'package:application/appwriteservice.dart';
import 'package:application/taskscreen.dart';
...
class _HomescreenState extends State<Homescreen> {
  ...
  Future<void> fetchTasks() async {
    try {
      final response = await appwriteService.database.listDocuments(
        databaseId: '6752c313003151ee1b3e', // Replace with your database ID
        collectionId: '6752c3200009864b07b1', //Replace with your collection ID
      );
  ...
  void editTask(String taskId, String title, String description, String date,
      String time) async {
      ...
      body: tasks.isEmpty
          ...
          : GridView.builder(
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                childAspectRatio: 0.999900, // Width to height ratio
              ),
